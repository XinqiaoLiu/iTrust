...
%>
	<tr>					
		...
		<td  align=center><%= StringEscapeUtils.escapeHtml("" + (action.doesFamilyMemberHaveDisease(member, "Diabetes") ? "x" : "")) %></td>
		<td  align=center><%= StringEscapeUtils.escapeHtml("" + (action.doesFamilyMemberHaveDisease(member, "Cancer") ? "x" : "")) %></td>
		<td  align=center><%= StringEscapeUtils.escapeHtml("" + (action.doesFamilyMemberHaveDisease(member, "HeartDisease") ? "x" : "")) %></td>
