...
<%
	...
	String prompt = "";
	String mes = "";
	if (request.getParameter("lhcp") != null) {
		...
		if (request.getParameter("request") != null) {
			...
			ViewMyMessagesAction rateAction = new ViewMyMessagesAction(prodDAO, hcpid);
			if(rateAction.getHcpRating() != 0){
				mes = "Rating: " + String.valueOf(rateAction.getHcpRating()) + " / 5";
			} else{
				mes = "No Rating";
			}
		}
	} else {
		ViewMyMessagesAction rateAction = new ViewMyMessagesAction(prodDAO, visits.get(0).getHCPMID());
		if(rateAction.getHcpRating() != 0){
			mes = "Rating: " + String.valueOf(rateAction.getHcpRating()) + " / 5";
		} else{
			mes = "No Rating";
...
<form action="appointmentRequests.jsp" method="post">
	<p>HCP:</p>
		<table>
		<td><select name="lhcp" onchange="this.form.submit()">
			<%
