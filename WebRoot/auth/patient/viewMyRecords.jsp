...
<table class="fTable" align="center" >
	...
	<tr>
		...
		<td  align=center><%=action
							...
							: ""%></td>
		<td  align=center><%=action
									.doesFamilyMemberHaveDisease(member, "Diabetes") ? "x"
							: ""%></td>
		<td  align=center><%=action.doesFamilyMemberHaveDisease(member, "Cancer") ? "x"
							: ""%></td>
		<td  align=center><%=action
									.doesFamilyMemberHaveDisease(member, "HeartDisease") ? "x"
							: ""%></td>
