...
<div class="panel panel-default">
	...
	<div class="panel-body" id="other-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/admin/reminderOutbox.jsp">Reminder Outbox</a></li>
			<li><a href="/iTrust/auth/admin/ratingInfo.jsp">Rating Information</a></li>
			<li><a href="/iTrust/auth/admin-tester/viewTransactionLogs.jsp">View Transaction Logs</a></li>
		</ul>
	</div>
</div>
