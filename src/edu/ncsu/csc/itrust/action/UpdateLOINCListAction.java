...
public class UpdateLOINCListAction {
	...
	private LOINCbean createBean(String[] beanInfo) {
		...
		bean.setLabProcedureCode((beanInfo[0] == null || beanInfo[0].isEmpty()) ? null : beanInfo[0]);
		bean.setComponent((beanInfo[1] == null || beanInfo[1].isEmpty()) ? null : beanInfo[1]);
		bean.setKindOfProperty((beanInfo[2] == null || beanInfo[2].isEmpty()) ? null : beanInfo[2]);
		bean.setTimeAspect((beanInfo[3] == null || beanInfo[3].isEmpty()) ? null : beanInfo[3]);
		bean.setSystem((beanInfo[4] == null || beanInfo[4].isEmpty()) ? null : beanInfo[4]);
		bean.setScaleType((beanInfo[5] == null || beanInfo[5].isEmpty()) ? null : beanInfo[5]);
		bean.setMethodType((beanInfo[6] == null || beanInfo[6].isEmpty()) ? null : beanInfo[6]);
		return bean;
	}
