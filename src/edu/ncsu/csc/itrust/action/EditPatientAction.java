...
public class EditPatientAction extends PatientBaseAction {
	...
	/**
	 * Update Patient Information for Filter
	 * @param fn The filter in String format
	 * @throws ITrustException
	 * @throws FormValidationException
	 */
	public void editMessageFilter(String fn) throws ITrustException, FormValidationException {
		PatientBean t = patientDAO.getPatient(this.getPid());
		t.setMessageFilter(fn);
		this.updateInformation(t);
	}
