...
public class EditPHRAction extends PatientBaseAction {
	...
	private ViewMyRecordsAction viewrecord;
	...
	public EditPHRAction(DAOFactory factory, long loggedInMID, String pidString) throws ITrustException {
		...
		this.viewrecord = new ViewMyRecordsAction(factory, loggedInMID);
	}
	...
	/**
	 * Checks to see if a particular family member has disease
	 * 
	 * @param member the family member to check
	...
	public boolean doesFamilyMemberHaveDisease(FamilyMemberBean member, String disease) throws ITrustException {
		return viewrecord.doesFamilyMemberHaveDisease(member, disease);
	}
