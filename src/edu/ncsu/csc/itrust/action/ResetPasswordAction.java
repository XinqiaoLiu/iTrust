...
public class ResetPasswordAction {
	...
	public String checkRole(long mid, String role) throws ITrustException {
		try {
			if (("patient".equals(role) && authDAO.getRole(mid, role).equals("patient"))
					|| ("hcp".equals(role) && authDAO.getRole(mid, role).equals("hcp"))
					|| ("uap".equals(role) && authDAO.getRole(mid, role).equals("uap"))
					|| ("pha".equals(role) && authDAO.getRole(mid, role).equals("pha"))
					|| ("er".equals(role) && authDAO.getRole(mid, role).equals("er"))
					|| ("lt".equals(role) && authDAO.getRole(mid, role).equals("lt")))
				return role;
			else
				return null;
		} catch (DBException e) {
