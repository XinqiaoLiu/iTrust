...
public class ViewMyMessagesAction {
	...
	/**
	 * Validates Filter inputs and create Filter
	 * @param fn The filter in String Format
	 * @return The filter parameters
	 */
	public String validateAndCreateFilter(String fn) {
		String[] f = fn.split(",", -1);
	 ...
	 * @throws DBException
	 */
	public double getHcpRating() throws DBException {
		return apptDAO.getHcpRating(loggedInMID);
	}
