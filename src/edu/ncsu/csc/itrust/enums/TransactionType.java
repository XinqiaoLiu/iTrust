...
public enum TransactionType {
	...
	/**PATIENT_ACTIVATE*/
	PREPATIENT_ACTIVATE(105, "Activate preregistered patient", "activated your account", true),
	/**PATIENT_ACTIVATE*/
	PREPATIENT_DEACTIVATE(106, "Deactivate preregistered patient", "deactivated your account", true),
	/**LHCP_CREATE*/
