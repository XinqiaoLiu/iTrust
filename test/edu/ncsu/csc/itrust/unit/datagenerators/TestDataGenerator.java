...
public class TestDataGenerator {
	...
	/**
	 * Adds prepatient John Donkey, used in the testing of UC92.
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void prepatient1() throws FileNotFoundException, SQLException,
			IOException {
	...
	/**
	 * Inserts a dead patient into the system.
	 * 
	 * @throws SQLException
	 * @throws FileNotFoundException
	 * @throws IOException
	 */
	public void deadPatient0() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/deadPatient0.sql");
	}	

	/**
	 * Inserts a dead patient into the system.
	 */
	public void deadPatient1() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient2() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient3() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient4() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient5() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient6() throws SQLException, FileNotFoundException, IOException {
	 ...
	 * @throws IOException
	 */
	public void deadPatient7() throws SQLException, FileNotFoundException, IOException {
	...
	/**
	 * Inserts a malaria Case into the system
	 *
	 * @throws SQLException
	 * @throws FileNotFoundException
	 * @throws IOException
	...
	public void malariaCase0() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase0.sql");
	}

	public void malariaCase1() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase1.sql");
	}

	public void malariaCase2() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase2.sql");
	}

	public void malariaCase3() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase3.sql");
	}

	public void malariaCase4() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase4.sql");
	}

	public void malariaCase5() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase5.sql");
	}

	public void malariaCase6() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCase6.sql");
	}

	public void malariaCaseFirst() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/malariaCaseFirst.sql");
	}



	public void fluCase0() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase0.sql");
	}

	public void fluCase1() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase1.sql");
	}

	public void fluCase2() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase2.sql");
	}

	public void fluCase3() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase3.sql");
	}

	public void fluCase4() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase4.sql");
	}

	public void fluCase5() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase5.sql");
	}

	public void fluCase6() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase6.sql");
	}

	public void fluCase7() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase7.sql");
	}

	public void fluCase8() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase8.sql");
	}

	public void fluCase9() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase9.sql");
	}

	public void fluCase10() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase10.sql");
	}

	public void fluCase11() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase11.sql");
	}

	public void fluCase12() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase12.sql");
	}

	public void fluCase13() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase13.sql");
	}

	public void fluCase14() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase14.sql");
	}

	public void fluCase15() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase15.sql");
	}

	public void fluCase16() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase16.sql");
	}

	public void fluCase17() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase17.sql");
	}

	public void fluCase18() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase18.sql");
	}

	public void fluCase19() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase19.sql");
	}

	public void fluCase20() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase20.sql");
	}

	public void fluCase21() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase21.sql");
	}

	public void fluCase22() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase22.sql");
	}

	public void fluCase23() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase23.sql");
	}

	public void fluCase24() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase24.sql");
	}

	public void fluCase25() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase25.sql");
	}

	public void fluCase26() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase26.sql");
	}

	public void fluCase27() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase27.sql");
	}

	public void fluCase28() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase28.sql");
	}

	public void fluCase29() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase29.sql");
	}

	public void fluCase30() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase30.sql");
	}

	public void fluCase31() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase31.sql");
	}

	public void fluCase32() throws SQLException, FileNotFoundException, IOException{
		new DBBuilder(factory).executeSQLFile(DIR + "/fluCase32.sql");
	}
